...
{
    /// <inheritdoc />
    public partial class ComicModels : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ComicAbstracts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ComicAbstracts_Comics_ComicId",
                        column: x => x.ComicId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ComicAbstracts_ComicId",
                table: "ComicAbstracts",
                column: "ComicId");

            migrationBuilder.CreateIndex(
                name: "IX_ComicAbstracts_Id",
                table: "ComicAbstracts",
                column: "Id",
                unique: true);
